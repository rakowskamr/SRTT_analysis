%% SRTT - error rate for both hands

% This script gets the error rate per block of the SRTT. Separate result
...
outputFolder_SWS = 'yourDirectory/Analysis/Results';
...
% Output file Name
name_R = 'R_S4_results_accuracy.mat'; % <----- reactivated sequence
name_NR = 'NR_S4_results_accuracy.mat'; % <----- non-reactivated sequence
...
for pSWS = 1:l_SWS
    ...
    results = sprintf('p%d_6-8w_Follow_up.mat', SWS_subjects(pSWS)); %<----- edit your input file name
